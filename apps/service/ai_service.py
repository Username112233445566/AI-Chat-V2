...
- Если изменить задачу (обновить, переименовать, поменять описание, срок и т.д.) → [UPDATE_TASK]
- Если удалить задачу (удали, убери, исключи) → [DELETE_TASK]
...
- "Удалить задачу с названием Позвонить клиенту" → нормальный ответ + [DELETE_TASK]
...
- "Измени задачу Позвонить клиенту на Позвонить завтра" → нормальный ответ + [UPDATE_TASK]
- "Обнови описание задачи Отчёт для менеджера" → нормальный ответ + [UPDATE_TASK]
- "Переименуй задачу Сходить в аптеку" → нормальный ответ + [UPDATE_TASK]
"""
